    ...
    plus.photo.prototype = {
        init: function () {
            ...
            if (this.croppable) {
                ...
                var wrapper = $('<div class="editor-wrapper"></div>').appendTo(stage);
                ...
                var cropper = $('<input type="image" text="Crop" class="cropper-export" src="' + (plus.config.baseUrl) + '/skin/icon/crop-24-white.png" />').appendTo(control);
                control.append('<br />');
                $('<input type="image" style="margin:1px 10px; width:24px; cursor:pointer;" title="rotate right" src="' + (plus.config.baseUrl) + '/skin/icon/browse-white-30-bold.png" />').appendTo(control).bind('click', function () {
                    browser.click();
                });

                $('<input type="image" style="margin:4px 10px; width:18px; cursor:pointer;" title="rotate right" src="' + (plus.config.baseUrl) + '/skin/icon/rotate-left-white.png" class="rotate-right" />').appendTo(control).bind('click', function () {
